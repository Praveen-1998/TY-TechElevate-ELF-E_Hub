...
export class DisplayimageComponent implements OnInit  {
  ...
  constructor(private showimageservice: ShowimageService, private billableEmployeesService: BillableEmployeesService, private revenueService: PackageService, private router: Router) {
